#!/usr/bin/env python3
"""Train a YOLOv8 OBB model for one-class chip ROI detection."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", required=True, type=Path, help="YOLO OBB data.yaml from prepare_obb_dataset.py.")
    parser.add_argument("--output-dir", required=True, type=Path, help="Training output directory.")
    parser.add_argument("--model", default="yolov8n-obb.pt", help="Initial YOLOv8 OBB weights or model yaml.")
    parser.add_argument("--name", default="chip_roi_yolov8_obb", help="Ultralytics run name.")
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit("Missing dependency: install ultralytics before OBB training.") from exc
