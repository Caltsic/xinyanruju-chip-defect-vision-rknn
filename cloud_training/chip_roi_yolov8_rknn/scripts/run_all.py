#!/usr/bin/env python3
"""Run the full chip ROI YOLOv8 -> ONNX -> RKNN pipeline."""
...
def main() -> None:
    ...
    dataset_out = work / "dataset_yolov8_chip_roi"
    final = work / "final"
    ...
    stable_best = final / "chip_roi_yolov8_detect.pt"
    if args.weights:
    ...
    onnx_path = final / "chip_roi_yolov8_detect.onnx"
    export_cmd = [
        sys.executable,
    ...
    if not args.skip_rknn:
        ...
        copy_required(rknn_dir / "chip_roi_yolov8_detect_fp.rknn", final / "chip_roi_yolov8_detect_fp.rknn")
        copy_required(rknn_dir / "chip_roi_yolov8_detect_int8.rknn", final / "chip_roi_yolov8_detect_int8.rknn")
