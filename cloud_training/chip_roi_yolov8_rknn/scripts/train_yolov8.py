#!/usr/bin/env python3
"""Train a YOLOv8 detection model for one-class chip ROI detection."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", required=True, type=Path, help="YOLO data.yaml from prepare_dataset.py.")
    parser.add_argument("--output-dir", required=True, type=Path, help="Training output directory.")
    parser.add_argument("--model", default="yolov8n.pt", help="Initial YOLOv8 weights or model yaml.")
    parser.add_argument("--name", default="chip_roi_yolov8_detect", help="Ultralytics run name.")
