#!/usr/bin/env python3
"""Convert YOLOv8-seg ONNX to FP and INT8 RKNN models for RK3576."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--name", default="chipcheck_yolov8_seg", help="Output model prefix.")
...
def main() -> None:
    args = parse_args()
    onnx_path, using_split = choose_onnx(args.onnx.resolve(), args.split_onnx.resolve() if args.split_onnx else None)
    ...
    if not args.skip_int8:
        int8_suffix = "split_int8" if using_split else "int8"
        int8_path = args.output_dir / f"{args.name}_{int8_suffix}.rknn"
